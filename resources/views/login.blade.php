  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbar">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="login" class="login-nav" >Se conncter</a></li>
              <li><a href="register" class="register" >S'inscrire</a></li>
            </ul>
          </div><!--/ Collapse -->
        </div>
      </nav>
    ...
    <section class="banner-grey">
      <div class="container sec-hq-pad-t sec-hq-pad-b">
        <h2 class="animated wow fadeIn">Offres d'emploi</h2>
      </div>
    </section>
    <!-- Banner Grey Ends -->

    <!-- User Profile Starts --> <br>
	<form class="form-horizontal" role="form" method="POST" action="http://localhost:8000/login">
                        <input type="hidden" name="_token" value="YbIeqK6KYSlAknH9Kc9COIElw13La1YiOFr0KI23">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                <a class="btn btn-link" href="http://localhost:8000/password/reset">Forgot Your Password?</a>
                            </div>
                        </div>
                    </form>
	  <!-- User Profile Ends -->
